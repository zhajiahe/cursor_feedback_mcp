#!/usr/bin/env python3
"""
Cursor Feedback MCP - 主程式入口
==============================================

此檔案允許套件透過 `python -m cursor_feedback_mcp` 執行。

使用方法:
  python -m cursor_feedback_mcp        # 啟動 MCP 伺服器
  python -m cursor_feedback_mcp test   # 執行測試
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Cursor Feedback MCP - 互動式回饋收集 MCP 伺服器"
    )
    ...
    try:
        ...
        try:
            ...
            if launch_desktop_app_func is None:
                ...
                print("   3. Web 模式指令：uvx cursor-feedback-mcp test --web")
                return False
